...
struct Quaternion
{
	 ...
	 *
	 * @param x, y, z, w all with type Type
	 ...
	 *
	 * @param x, y, z, w all with types Type2, Type3, Type4, and Type5
	 * @return Quaternion(x,y,z,w) where w is scalar
	 */
	 ...
	 *
	 * @param Vector3<Type> v, Type w where v is the axis and w is the angle in radians
	 ...
	 *
	 * @param Vector3<Type> v an euler format z,y,x, bool usingTrig method to calculate
	 ...
	 *
	 * @param Quaternion<Type> q the quaternion to convert
	 ...
	 */
	static Matrix3<Type> ToRotationMatrix(const Quaternion<Type>& q)
	{
		Matrix3<Type> ret;
		Type y2 = q.Y * q.Y;
		Type x2 = q.X * q.X;
